...
Refazer os exercícios do 18 ao 26 com procedimentos (Sem retorno) em Python sem passagem de parâmetros (Com variáveis globais)]:
...
Refazer os exercícios do 27 ao 29 com procedimentos em Python com passagem de parâmetros (Com variáveis locais):
